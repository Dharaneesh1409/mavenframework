...
public class ReadFromExcel {
    ...
    /**
     * function will evaluate and return cell values
     * 
     * @param sheet
     *            : Sheet Name
     * @param cellRange
    ...
    /**
     * function will evset cell value
     * 
     * @param sheet
     *            : Sheet Name
     * @param cellRange
    ...
    /**
     * function to get the data for template report
     * 
     * @param sheet
     *            : Sheet Name
     * @param startColumn
    ...
    public static List<List<HSSFCell>> getData_Template_Report(HSSFSheet sheet, Integer startColumn) {
        ...
        try {
                ...
                if (r != null) {
                    ...
                    for (int cn = startColumn; cn < lastColumn; cn++) {
                        ...
                        if (c == null) {
                            ...
                            // This get cell function is returning 1564.23% to ceeIn = 15.6423
                            HSSFCell celln = (HSSFCell) r.getCell(cn);
                            data.add(celln);
                        }
                    }
            ...
            // MyPropsLogger.getLogger().error("Exception in getData_Template_Report: " +
            // e.getMessage(), e);
