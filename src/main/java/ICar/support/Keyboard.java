...
/**
 * Keyboard class handles all keyboard events related actions and methods to
 * type,press,enter using robot class
 * 
 */
public class Keyboard {
	...
	/**
	 * Keyboard type is for typing alphabets , numeric, special characters
	 * 
	 * @param character
	 *            - keyboard character
	 */
	...
	/**
     * To type the keycodes with offset value and length
     * 
     */
