...
//
//				
//				String alerts_report = new String(api.core.xmlreport(null));
//						//xmlreport()
//
...
//				api.ascan.scan(ZAP_URI_PORT,null,"true", null, null, null, null);
//				// To see when scan is done - Currently am not sure how to work with the ApiRepsonse Object
//				while (api.ascan.status(null).toString(0).contains(breakBy) == false) {
//					Log.event("Active scan progress: " + api.ascan.status(null).toString(0));
//					try {
...
////						break;
//				}
//				Log.event("progress: " + api.ascan.status(null).toString(0));
//			}// try
//			catch (Exception ex) {
...
//				spider.scan(ZAP_URI_PORT, null, null, null);
//
...
//					Log.event("progress: " + spider.status(null).toString(0));
//					try {
...
//			 ignoreAlerts.add(new Alert(null, null));
//			 ignoreAlerts.add(new Alert(null, null));
//			 
//			 requireAlerts.add(new Alert("Application Error Disclosure", null));
//			 requireAlerts.add(new Alert("Cross Site Scripting (Persistent)", null));
//			 requireAlerts.add(new Alert("Cross Site Scripting (Reflected)", null));
//			 requireAlerts.add(new Alert("Remote OS Command Injection", null));
//			 requireAlerts.add(new Alert("SQL Injection", null));
//			try {
