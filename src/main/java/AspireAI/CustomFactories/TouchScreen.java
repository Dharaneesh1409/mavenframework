...
public interface TouchScreen {
	 ...
	 * Mouse.
	 *
	 * @param where The location on the screen. Typically a
	 ...
	 * first of a sequence of touch gestures.
	 *
	...
	/**
	 * Allows the execution of the gesture 'up' on the screen. It is typically the
	 * last of a sequence of touch gestures.
	 *
	 * @param x The x coordinate relative to the viewport
	 * @param y The y coordinate relative to the viewport
	 */
	 ...
	 *
	 * @param where   the location where the scroll starts, usually a
	 *                {@link org.openqa.selenium.WebElement}.
